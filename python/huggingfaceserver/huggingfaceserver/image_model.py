...
class HuggingfaceImageModel(Model):  # pylint:disable=c-extension-no-member
    ...
    # only load model , no need put data into
    def load(self) -> bool:
    ...
    def postprocess(
        self, outputs: Union[Tensor, InferResponse], 
        context: Dict[str, Any]
        ...
        # if output type is InferResponse, transfer to Tensor
        ...
        #         mask_pos = (pixel_values == self._tokenizer.mask_token_id)[i]
